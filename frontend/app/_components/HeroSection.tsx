    ...
    return (
        <div className=" px-10 lg:px-48 min-h-[500px] w-full flex justify-between items-center pt-[100px]">
            <div className="flex flex-col items-center md:items-start gap-y-4 md:w-1/2">
                ...
                <button onClick={() => { router.push('/dashboard') }} className="bg-black text-white px-4 py-2 my-2 md:text-xl font-semibold hover:bg-white hover:text-black border-2 border-black">Trade Online</button>
            </div>
